...
# Use query 'a' to fetch all public entries in Boston Public Library
BASE_URL = "https://www.digitalcommonwealth.org/search.json?f%5Bphysical_location_ssim%5D%5B%5D=Boston+Public+Library&per_page=100&q=a"
